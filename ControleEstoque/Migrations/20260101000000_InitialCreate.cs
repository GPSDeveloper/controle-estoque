...
namespace ControleEstoque.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PossuiValidade = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantidade = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    NomeRetirante = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    TipoIdentificacao = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Saidas_Materiais_MaterialId",
                        column: x => x.MaterialId,
                        principalTable: "Materiais",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Saidas_Setores_SetorId",
                        column: x => x.SetorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Saidas_MaterialId",
                table: "Saidas",
                column: "MaterialId");

            migrationBuilder.CreateIndex(
                name: "IX_Saidas_SetorId",
                table: "Saidas",
                column: "SetorId");
        ...
        {
            migrationBuilder.DropTable(name: "Saidas");
